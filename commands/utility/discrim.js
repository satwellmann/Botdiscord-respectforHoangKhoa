...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if (!discrims.length) return message.reply("Tôi không thể tìm thấy người dùng có sự phân biệt đối xử đór");
    ...
    sourcebin.create([{
      ...
      .setTitle(`Người dùng với ${dis[0]}`)
      .setDescription(`${content}\n\n**[Url](${src.url})**`)
      .setFooter(`Tìm ${discrims.length} người dùng`, client.user.displayAvatarURL())
