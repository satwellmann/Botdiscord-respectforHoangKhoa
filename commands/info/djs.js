...
module.exports = {
    ...
    run: async(client, message, args) => {
        ...
        if (!search) return message.channel.send({
            embed: {
                "color": 0x4D5E94,
                "description": "❌ **Bạn đang tìm kiếm cái gì?**"
        ...
        fetch(`https://djsdocs.sorta.moe/v2/embed?src=${encodeURIComponent(version)}&q=${encodeURIComponent(search)}`)
            ...
            .catch(e => {
                message.channel.send({
                    embed: { "color": 0x4D5E94, "author": { "name": "Discord.js Docs (master)", "url": "https://discord.js.org/#/docs/main/master", "icon_url": "https://discord.js.org/favicon.ico" }, "title": "Kết quả tìm kiếm:", "description": "Ko có kết quả." }
                });
            });
    }
}